...
const Home = () => {
  ...
  return (
    <div id="home" className="relative min-h-screen flex items-center pt-24 pb-20 overflow-hidden font-outfit">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
        ...
        >
          {/* Status Badge */}
          <motion.div variants={itemVariants} className="flex items-center gap-3 px-5 py-2.5 rounded-full glass border border-white/5">
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            <h1
              className="text-[14vw] sm:text-[10vw] lg:text-[7vw] font-black leading-[0.85] tracking-tighter uppercase"
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-4 pt-2 w-full">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="akash new.pdf"
              className="group relative px-8 py-4 bg-aurora-primary rounded-2xl font-bold uppercase tracking-widest text-white overflow-hidden transition-all shadow-2xl shadow-aurora-primary/30 inline-flex items-center gap-3 text-sm"
            >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#contact"
              className="px-8 py-4 rounded-2xl font-bold uppercase tracking-widest text-sm text-gray-300 glass border border-white/10 hover:border-aurora-primary/50 transition-all"
            >
              Let&apos;s talk
            </motion.a>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#project"
              className="group px-7 py-4 rounded-2xl font-black uppercase tracking-[0.18em] text-[11px] text-white bg-gradient-to-r from-aurora-secondary/90 to-aurora-accent/90 border border-white/20 inline-flex items-center gap-3"
            >
              View Featured Work
